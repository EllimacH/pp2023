...
class Classroom:
    ...
    def input_mark(self, course_list: list) -> None:
        ...
        while True:
            for student in self.student_list:
                ...
                student_id_input = input(
                    "Student id not found, please try again: ").upper()
                continue
            break
        ...
        # -------- Input type of mark ---------
        type_of_mark_input = input(
            "Enter type of mark (attend/midterm/final): ")
        while True:
            if type_of_mark_input in ["attend", "midterm", "final"]:
                break
            else:
                type_of_mark_input = input(
                    "Type of mark is not valid, please try again: ")
    ...
    def print_students_infos(self, course_list: list) -> None:
        for student in self.student_list:
            ...
            print(
                f"- {student['student_name']} - {student['student_id']} - {student['student_DOB']}")
            print("Marks:")
            for mark in student["marks"]:
                ...
                print(
                    f"Course: {course_name} ({mark['course_id']}): {attend_mark} {midterm_mark} {final_mark} | GPA: {gpa_mark}")
        ...
        for student in self.student_list:
            for course in student["marks"]:
                for item in ["attend", "midterm", "final"]:
                    ...
                    mark_array = np.array(
                        [attend_mark, midterm_mark, final_mark])
